...
if "!GitQueryType!"=="1" (
    ...
    rem "開一個 method 用 goto 去呼叫，設置一個 checkDateFormatType"
    rem "checkDateFormatType:作用=做完並返回指定的地方"
    rem "作法:"
    rem "yyyyMMdd or yyyyMMddHHmmss 兩種格式，其餘都顯示格是錯誤"
    rem "轉換為對應格式 yyyyMMddTHHmmssZ"
