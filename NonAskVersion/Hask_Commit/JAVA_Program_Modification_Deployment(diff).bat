...
rem git 起始CommitID 格式: 8623a05f
set FROM_CommitID=8623a05f
rem git 截止CommitID 格式: 454f509d
set TO_CommitID=454f509d
rem 存放檔案位置
rem 範例 : set Final_Target_File_Address="\\File-server\share\企業簡訊事業群\簡訊研發部\公用資料夾\【中心端調整】\20230526_測試用"
set Final_Target_File_Address="20240112_測試用"
...
echo "git diff -r --no-commit-id --name-only --text  8623a05f 454f509d"
